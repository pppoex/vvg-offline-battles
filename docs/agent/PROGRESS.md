...
| 14 | TASK-M6.P3 | worker_pose 中继 + 原地 Bot + catalog_hash | 已完成 | protocol, sim_worker room/session/server, worker_authority, tests | pytest 全绿 + Py2.7 编译 | 待 commit | 2026-09-14 |
